...
lsTraces = {};
ls2x2PrincipalMinorsSum = {};
ls3x3PrincipalMinorsSum = {};
...
lsTraces = append(lsTraces, trace(C));

g = 0;
for i from 0 to n!-1 do (
for k from i+1 to n!-1 do (
g = g + det(submatrix(C,{i,k},{i,k}));
);
);
ls2x2PrincipalMinorsSum = append(ls2x2PrincipalMinorsSum, g);

);

Rel = ideal(lsTraces)+ideal(ls2x2PrincipalMinorsSum)+ideal(ls3x3PrincipalMinorsSum);
decompose Rel
...
for i from 0 to n!-1 do (
for k from i+1 to n!-1 do (
for m from k+1 to n!-1 do (
g = g + det(submatrix(C,{i,k,m},{i,k,m}));
);
);
);
ls3x3PrincipalMinorsSum = append(ls3x3PrincipalMinorsSum, g);
